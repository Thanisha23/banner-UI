  ...
  <div className="relative bg-white bg-opacity-30 rounded-xl shadow-2xl p-4 sm:p-6 lg:p-10 w-full sm:w-[90%] lg:w-[80%] mx-auto">
    <div className="max-w-3xl mx-auto">
      <input 
        ...
        className="w-full px-3 py-2 sm:px-4 sm:py-3 text-base sm:text-lg shadow-xl rounded-lg sm:rounded-xl mb-4 sm:mb-6" 
        type="text" 
      />
      <button className="bg-gradient-to-r from-violet-300 to-pink-300 hover:bg-gradient-to-bl hover:from-pink-300 hover:to-violet-300 mx-auto w-full shadow-xl px-4 py-2 sm:px-6 sm:py-3 flex justify-center items-center text-white font-bold rounded-full mb-6 sm:mb-10 text-base sm:text-xl transition-all">
        Generate Banners
      </button>
